...
import { Bell, Shield, Palette, Globe, Mail, Phone, User } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Get notified about your bot trades and transactions</p>
                </div>
                <Switch 
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Stay updated with important market news</p>
                </div>
                <Switch 
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customize your platform appearance and language preferences
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button className="btn-gaming">Save Changes</Button>
          </div>
        </div>
      </main>
    </div>
